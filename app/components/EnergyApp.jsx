        ...
        <div className="max-w-sm w-full bg-white/[0.02] border border-white/[0.05] p-6 rounded-[2rem] backdrop-blur-sm mt-4">
          <div className="flex items-start gap-3 text-left">
             ...
             <div className="space-y-2">
                ...
                <p className="text-[10px] text-slate-500 leading-relaxed italic opacity-80 text-justify">整合亲子关系、家庭动力学及情绪发展理论，不仅看“谁在吸你的能”，更看“你为何成为目标”。</p>
             </div>
          </div>
        </div>
      </div>
  ...
  if (step === 'transition') {
    return (
      <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-12 text-center">
        ...
        <p className="text-slate-500 text-sm mb-12 leading-relaxed italic opacity-80 text-center">接下来，让我们把镜头对准你<br/>扫描你当前的<span className="text-indigo-400 font-bold">内在能量补给状态</span></p>
      ...
      return (
        <div className="min-h-screen bg-black/95 flex items-center justify-center p-6 animate-in fade-in zoom-in duration-300 z-50">
           ...
           <div className="w-full max-w-[340px] bg-slate-950 rounded-[2.5rem] border border-white/10 overflow-hidden shadow-[0_0_50px_rgba(99,102,241,0.3)] relative text-center">
              <div className={`h-28 bg-gradient-to-b ${bg} to-slate-950 p-6 flex flex-col items-center justify-center`}>
              ...
              <div className="px-8 pb-10 flex flex-col items-center">
                  ...
                  <div className="w-full bg-white/[0.02] border border-white/5 rounded-[2rem] p-4 mb-6 text-center">
                      <div className="flex items-center justify-between mb-2"><span className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Loss Pattern Scan</span><span className="text-[9px] font-black text-indigo-400">{scoreA} PTS</span></div>
