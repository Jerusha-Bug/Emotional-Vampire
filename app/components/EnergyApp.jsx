          ...
          {(() => {
            ...
            return (
              <section className="mb-4 relative overflow-hidden"
                style={{background:`${rc}0.07)`, borderRadius:'24px', border:`1px solid ${rc}0.2)`, boxShadow:`inset 0 0 40px ${rc}0.07)`}}>
                <Fingerprint className="absolute top-2 right-2 pointer-events-none"
                  style={{width:'80px', height:'80px', color:`${rc}0.10)`, strokeWidth:1}} />
